        ...
        <div className="lg:col-span-5 relative">
          <div className="aspect-[4/5] relative group">
            <ImageContainer className="w-full h-full">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-primary/20 via-primary/10 to-transparent flex flex-col justify-end p-10">
